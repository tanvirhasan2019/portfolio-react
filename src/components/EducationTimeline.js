    ...
    return (
        <div style={{ marginTop: '20px', backgroundColor: 'white', padding: '0px' }} className="container">
            ...
            <Timeline lineColor={'#3f51b5'}>
                ...
                >
                    <Paper style={{
                        borderRight: '4px solid #3f9c63',
                        borderBottom: '4px solid #3f9c63'
                    }} className="education-varsity" elevation={3}>
                ...
                >
                    <Paper style={{
                        borderRight: '4px solid #e86971',
                        borderBottom: '4px solid #e86971'
                    }} className="education-varsity" elevation={3}>
                ...
                <TimelineItem
                    ...
                    style={{ color: '#3f51b' }}
                >
                    <Paper style={{ borderRight: '4px solid blue', borderBottom: '4px solid blue' }} className="education-varsity" elevation={3}>
