             ...
             <div className="container-fluid">
                <div style={{margin:'15px 15px'}} className="row">
                    ...
                    <div className="col-md-6 d-flex flex-column justify-content-center">
                        ...
                        <div className="row">
                        <div className="col">
                          <p className="motivate">A passionate Full Stack Software Developer 🚀 designing and building Web  applications with JavaScript / Reactjs / Nodejs / .Net and some other cool libraries
                           and frameworks.</p>
                       </div>
